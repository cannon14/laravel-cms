...
$iAPR = strtolower($this->cardData['Intro APR']);
$iAPRPeriod = strtolower($this->cardData['Intro APR Period']);
$bAPR = strtolower($this->cardData['Balance Transfer Intro APR']);
$bAPRPeriod = strtolower($this->cardData['Balance Transfer Intro Period']);
