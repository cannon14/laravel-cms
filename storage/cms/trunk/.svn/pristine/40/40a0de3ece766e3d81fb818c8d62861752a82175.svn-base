...
function preloadIcons() {
	...
	icons[4] = new Image();
	icons[4].src = "img/page.gif";
	icons[5] = new Image();
	icons[5].src = "img/page.gif";
}
// Create the tree
function createTree(arrName, startNode, openNode) {
	...
	if (nodes.length > 0) {
		...
		if (startNode !=0) {
			...
			document.write("<a href=\"" + nodeValues[3] + "\" onmouseover=\"window.status='" + nodeValues[2] + "';return true;\" onmouseout=\"window.status=' ';return true;\"><img src=\"img/globe.gif\" align=\"absbottom\" alt=\"\" />" + nodeValues[2] + "</a><br />");
...
function addNode(parentNode, recursedNodes) {
	for (var i = 0; i < nodes.length; i++) {
		...
		if (nodeValues[1] == parentNode) {
			...
			if (hcn) {
				document.write("<img id=\"icon" + nodeValues[0] + "\" src=\"img/page")
					if (ino) document.write("open");
				document.write(".gif\" align=\"absbottom\" alt=\"\" />");
			} else document.write("<img id=\"icon" + nodeValues[0] + "\" src=\"img/card.gif\" align=\"absbottom\" alt=\"Page\" />");
