        ...
        <div class="row">
                        ...
                        if(REVIEWS_ENABLED) {
                            ...
                            if(!$api->isNull()) {
                                ...
                                if($data->status === 200) {
                                    ...
                                    echo "<div class='category-total-reviews'><a href='$detailPageLink'>".number_format($total_reviews)." customer reviews</a></div>";
                                }
                            }
                        }
                        ?>
            ...
            <div class="col-xs-24 col-sm-14 col-md-15 col-lg-17">
                <div class="res-details">
                    ...
                    array_push($detailTextParts, '<li>See complete <a href=' . $this->siteProp['individualcarddir'] . '/' . $this->card->get('cardLink') . '.' . $this->siteProp['pagetype'] . '?catid=' . $this->page->get('fid') . '>' . $this->card->get('cardTitle') . ' details</a></li></ul></div>');
                    ...
                    <div class="category-showhide-btn">
	                    <a class="collapsed" data-toggle="collapse" data-target="#<?= $this->card->get('cardId') ?>">
                            <span class="showHide-text">Show More</span> <?= $amex_specific_text ?>
                        </a> &nbsp;&nbsp;<i class="fa fa-chevron-down" style="color: #156abd" data-toggle="collapse" data-target="#<?= $this->card->get('cardId') ?>"></i>
                    </div>
                </div>
            </div>
        </div>
                ...
                <ul class="responsive-table">
                    <li class="first-row">
                        ...
                        <dl>
                            ...
                            <dd id="card-<?= $rawCardData['cardId'] ?>-interest" class="true_interest_result"><?= $trueInterestPlaceholderText ?></dd>
                        </dl>
                        <?php else : ?>
                        <dl>
                            <dt>
            ...
            <?php } elseif(array_key_exists($this->page->get('cardpageId'), $prepaidDebitPageId)) { ?>
                ...
                <ul class="responsive-table-prepaid">
                    <li class="first-row">
                        <dl>
                            <dt>Purchases Intro APR</dt>
                            <dd><?= $this->cardData['Intro APR'] ?></dd>
                        </dl>
                        <dl>
                            <dt>Balance Transfers Intro APR</dt>
                            <dd><?= $this->cardData['Balance Transfer Intro APR'] ?></dd>
                        </dl>
                        <dl>
                            <dt>Regular
                                APR
