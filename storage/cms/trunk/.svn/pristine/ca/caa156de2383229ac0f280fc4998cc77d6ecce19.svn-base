...
class CMS_layouts_cardpagelayouts_ccacCardPageLayout extends CMS_layouts_cardPageLayout {
	
	var $headerTemplate = 'ccac/card_header';
	var $subFooterTemplate = 'ccac/sub_footer';
	var $footerTemplate = 'ccac/card_footer';
	var $cardTemplate = 'ccac/card_listing';
	var $subHeaderTemplate = 'ccac/sub_header';
