...
@section('scripts')
    <script src="/js/app/controllers/reviews/CreateMapController.js" defer></script>
    <script src="/js/app/services/reviews/service.js" defer></script>
@endsection

@section('content')

<div class="container" ng-controller="CreateMapController">
    <div class="row">
        <div class="col-lg-12">
            <h1>Create Map</h1>
        </div>
    ...
    <div class="row">
        <div class="col-lg-12">
            <form>
                ...
                <button type="button" class="btn btn-primary" ng-click="createMap()">Create</button>
            </form>
        </div>
    </div>
</div>
