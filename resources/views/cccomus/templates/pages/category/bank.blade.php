<?php
/**
 * Name: Bank Card Category Page
 * Type: category
 * Description: Bank Card Category Page
 * Version: 1.0.0
 * Date: 2015-11-20
 */
?>
    ...
    <script>
        $(document).ready(function() {
            ...
            target.on('click', function(e) {
                ...
                $(this).parent().find('.res-details ul li').toggle();
    ...
    <div class="card-category-block">
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <!--right gutter-->
                <div class="col-lg-6">
                    @if(View::exists('templates.partials.gutters.'.$page->slug))
                        @include('templates.partials.gutters.'.$page->slug)
                    @endif
                </div>
            </div>
        </div>
