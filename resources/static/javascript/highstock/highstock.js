...
(function () {
    ...
    E && E.init.call(E, Fb);
    var ob = T.adapterRun, $b = T.getScript, ya = T.inArray, p = T.each, pb = T.grep, ac = T.offset, za = T.map, z = T.addEvent, U = T.removeEvent, N = T.fireEvent, bc = T.washMouseEvent, qb = T.animate, gb = T.stop, T = {
        enabled: !0,
        x: 0,
        y: 15,
    ...
    la.prototype = {
        ...
        buildText: function (a) {
            ...
            var j =
                this.label(a, b, c, i, null, null, null, null, "button"), k = 0, l, m, n, o, y, I, a = {
                x1: 0,
                y1: 0,
                x2: 0,
                y2: 1
            ...
            var e = ga(a) ? a.r :
                e, g = this.createElement("rect"), a = ga(a) ? a : a === r ? {} : {
                x: a,
                y: b,
                width: v(c, 0),
                height: v(d, 0)
    ...
    J.prototype = {
        ...
        getTitlePosition: function () {
            var a =
                this.horiz, b = this.left, c = this.top, d = this.len, e = this.options.title, f = a ? b : c, g = this.opposite, h = this.offset, i = G(e.style.fontSize || 12), d = {
                low: f + (a ? 0 : d),
                middle: f + d / 2,
                high: f + (a ? d : 0)
        ...
        render: function () {
            ...
            if (qa)b = a.getLinePath(qa), a.axisLine ? a.axisLine.animate({d: b}) : a.axisLine = e.path(b).attr({
                stroke: f.lineColor,
    ...
    L.prototype = {
        ...
        drawPoints: function () {
            ...
            if (d.enabled !== !1 || this._hasPointMarkers)for (f = b.length; f--;)if (g = b[f], d = V(g.plotX), e = g.plotY, k = g.graphic, i = g.marker || {}, a = o && i.enabled === r || i.enabled, m = c.isInsidePlot(u(d), e, c.inverted), a && e !== r && !isNaN(e) && g.y !== null)if (a = g.pointAttr[g.selected ? "select" : ""] || l, h = a.r, i = q(i.symbol, this.symbol), j = i.indexOf("url") === 0, k)k[m ? "show" : "hide"](!0).animate(s({
                x: d - h,
                y: e - h
        ...
        drawGraph: function () {
            ...
            p(c, function (c, h) {
                var k = c[0], l = a[k];
                if (l)gb(l), l.animate({d: g}); else if (d && g.length)l = {
                    stroke: c[1],
                    "stroke-width": d,
                    fill: $,
                    zIndex: 1
    ...
    s(xa.prototype, {
        addSeries: function (a, b, c) {
            ...
            if (!d)b.loadingDiv = d = aa(Va, {className: "highcharts-loading"}, s(e.style, {
                zIndex: 10,
                display: $
    ...
    L.prototype.alignDataLabel = function (a, b, c, d, e) {
        ...
        }).attr({align: c.align}) : (b.align(c, null, d), g = b.alignAttr, q(c.overflow, "justify") === "justify" ? this.justifyDataLabel(b, c, g, j, d, e) : q(c.crop, !0) && (a = f.isInsidePlot(g.x, g.y) && f.isInsidePlot(g.x +
        ...
        function () {
            ...
            if (a.visible && (e.enabled || a._hasPointLabels)) {
                ...
                if (Da(R) === 0 || this.verifyDataLabelOverflow(R))this.placeDataLabels(), r && g && p(this.points, function (b) {
                    j = b.connector;
                    t = b.labelPos;
                    if ((s = b.dataLabel) && s._pos)D = s._attr.visibility, z = s.connX, O = s.connY, k = l ? ["M", z + (t[6] === "left" ? 5 : -5), O, "C", z, O, 2 * t[2] - t[4], 2 * t[3] - t[5], t[2], t[3], "L", t[4], t[5]] : ["M", z + (t[6] === "left" ? 5 : -5), O, "L", t[2], t[3], "L", t[4], t[5]], j ? (j.animate({d: k}), j.attr("visibility", D)) : b.connector = j = a.chart.renderer.path(k).attr({
    ...
    var ca = L.prototype, E = Ib.prototype, gc = ca.processData, hc = ca.generatePoints, ic = ca.destroy, jc = E.tooltipHeaderFormatter, kc = {
    ...
    s(F, {
        navigator: {
            ...
            series: {
                ...
                compare: null,
                fillOpacity: 0.05,
                dataGrouping: {approximation: "average", enabled: !0, groupPixelWidth: 2, smoothed: !0, units: E},
    ...
    Bb.prototype = {
        drawHandle: function (a, b) {
            var c =
                this.chart, d = c.renderer, e = this.elementsToDestroy, f = this.handles, g = this.navigatorOptions.handles, g = {
            ...
            if (!isNaN(a)) {
                ...
                if (!(l.translate(d, !0) - l.translate(c, !0) < e.xAxis[0].minRange)) {
                    ...
                    if (z) {
                        this.leftShade[e](r.maskInside ? {x: g + b, y: x, width: c - b, height: t} : {
                            x: g,
                            y: x,
                            width: b,
                            height: t
                    ...
                    if (p && k)this.drawScrollbarButton(0), this.drawScrollbarButton(1), k[e]({
                        translateX: i,
                        translateY: u(E + t)
                    }), n[e]({width: j}), g = o + b, h = a - F, h < w && (D = (w - h) / 2, h = w, g -= D), this.scrollbarPad = D, m[e]({
                        x: V(g) + F % 2 / 2,
                        width: h
                    }), w = o + b + a / 2 - 0.5, this.scrollbarRifles.attr({visibility: a > 12 ? "visible" : "hidden"})[e]({
                        d: ["M",
            ...
            a.navigatorEnabled ? (a.xAxis = c = new J(b, x({ordinal: m && m.xAxis.options.ordinal}, f.xAxis, {
                id: "navigator-x-axis",
                isX: !0,
                type: "datetime",
                index: n,
        ...
        clickButton: function (a, b) {
            ...
            if (!(j === null ||
                ...
                if (o === "month" || o === "year")l = {
                    month: "Month",
                    year: "FullYear"
                }[o], n["set" + l](n["get" + l]() - s), l = n.getTime(), j = q(j, Number.MIN_VALUE), isNaN(l) || l < j ? (l = j, m = A(l + i, k)) : i = m - l; else if (i)l = v(m - i, j), m = A(l + i, k); else if (o === "ytd")if (h) {
                ...
                }) : (d = e.options.xAxis, d[0] = x(d[0], {range: i, min: t}));
                c.setSelected(a)
            }
        },
    ...
    Q.StockChart = function (a, b) {
        var c = a.series, d, e = q(a.navigator && a.navigator.enabled, !0) ? {
                startOnTick: !1,
                endOnTick: !1
            } : null, f = {marker: {enabled: !1, radius: 2}, states: {hover: {lineWidth: 2}}},
    ...
    M(J.prototype, "drawCrosshair", function (a, b, c) {
        ...
        if (t(this.crosshair.label) && this.crosshair.label.enabled && t(c)) {
            ...
            }).css(s({color: "white", fontWeight: "normal", fontSize: "11px", textAlign: "center"},
                f.style)).add();
            ...
            if (m < j || m > j + this.height)this.hideCrosshair(); else {
                ...
                k.attr({
                    text: n ? La(n, {value: c[g]}) : f.formatter.call(this, c[g]),
                    x: l,
                    y: m,
                    visibility: "visible"
                });
