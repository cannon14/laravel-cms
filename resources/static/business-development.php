...
if (isset($_REQUEST['validate'])) {
	...
	if(!isset($_REQUEST['ORGANIZATION']) || $_REQUEST['ORGANIZATION'] == '') {
		$errors['organization'] = 'Please specify your organization.';
	}
	...
	if (!isset($_REQUEST['BUSINESSCOMMENTS']) || $_REQUEST['BUSINESSCOMMENTS'] == '') {
		$errors['comments'] = 'Please describe the business opportunity you wish to discuss.';
	}
	...
	if (empty($errors)) {
		require_once('business_development_script.php');
	}
}
...
$htmlTitle = 'Credit Card Business Development Contact Form';
$metaKeywords = '';
$metaDescription = 'Contact the CreditCards.com business development department with partnership or product proposals.';
...
<div class="other-block">
	<div class="container">
		<div class="row">
			...
			<p>Please use the following form to contact us regarding Business Development opportunities. We will provide an email response usually within one business day of receipt of your inquiry.</p>
			<br>
			<?php if (!empty($errors)): ?>
			<div class="alert alert-danger" role="alert"> <strong>Please check the following</strong>
				<ul>
			...
			<form class="form-horizontal" role="form" method="post">
				...
				<div class="form-group <?php if (isset($errors['organization'])) { echo $error_class; } ?>">
				...
				<div class="form-group <?php if (isset($errors['comments'])) { echo $error_class; } ?>"> <br>
					<div class="col-sm-14">
						<label for="comments" class="control-label">Briefly describe the business opportunity you wish to discuss*</label>
						<textarea class="form-control" name="BUSINESSCOMMENTS" rows="3"><?= $_REQUEST['BUSINESSCOMMENTS'] ?>
</textarea>
					</div>
				</div>
				<div class="form-group <?php if (isset($errors['captcha'])) { echo $error_class; } ?>"> <br>
					...
					<div class="col-sm-5"> <img style="border:1px solid #A5ACB2" align="middle" src="/lib/captcha/captcha.php"> </div>
				</div>
				<br>
				<div class="form-group">
...
$channel = 'contact-us';
$pageName = $channel.':business-development';
$analyticsServer = '';
$pageType = '';
$prop1 = 'contact us';
$prop2 = '';
