...
function inviteFriend(){
    window.location = "mailto:?subject=Experian Town Hall on Credit Reports, Scores&body=An online town hall event with a live video feed from Experian: http://www.creditcards.com/askexperian. Coming on Thursday, May 6, at 2 p.m. Central.";
}

function launchViewer() {
    
    window.open('viewer.php', 'whitehouse', 'width=430,height=470,status=0');
