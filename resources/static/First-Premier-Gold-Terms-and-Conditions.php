...
<div class="other-block">
	<div class="container">
		<div class="row">
			...
			<p>Below are the account fees, rates, costs, limitations, available credit and other terms for the <strong>First PREMIER Bank Credit Card</strong>  offer. </p>
...
$pageName = $channel.':premier-secured';
$analyticsServer = '';
$pageType = '';
