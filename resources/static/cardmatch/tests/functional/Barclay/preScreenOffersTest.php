...
class Barclay_PreScreenOffersTest extends Cardmatch_DbTestCase {
	...
	public function testGetSkus(Cardmatch_User $user, $expectedStatus, $expectedSkus) {
		...
		$apiConfig = $config->channels->Barclay->params;
		...
		$channel = new Cardmatch_Channel_Barclay($apiConfig);
...
//		echo json_encode($users); exit;
	...
	public function samplePersonProvider(){
		...
		$applicant = $applicants[0]; // Test Test
