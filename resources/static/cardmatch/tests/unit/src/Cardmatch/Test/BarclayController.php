...
class BarclayControllerTest extends PHPUnit_Framework_TestCase {
	protected $_controller;

	public function setUp() {
		$this->_controller = new Cardmatch_Test_BarclayController();
	}


	public function testRun() {
		$controllerMock = $this->getMockBuilder('Cardmatch_Test_BarclayController')
	...
	public function testShowForm() {
		...
		$this->expectOutputRegex('/.*Barclay Test Users.*/');
