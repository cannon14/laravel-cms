...
require('actions/interview.php');

$MailToAddress = "vandana.nayak@creditcards.com"; // your email address
$redirectURL = "thankyou.php"; // the URL of the thank you page.

# optional settings
$MailSubject = "[Interview Invitation: CreditCards.com]"; // the subject of the message you will receive
