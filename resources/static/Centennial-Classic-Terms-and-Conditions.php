...
$pageName = $channel.':premier-centennial-classic';
$analyticsServer = '';
$pageType = '';
...
if (SITE_CATALYST_ENABLED) {
	$channel = 'BANK';
	$pageName = $channel.':first premier:centennial classic:terms of service';
