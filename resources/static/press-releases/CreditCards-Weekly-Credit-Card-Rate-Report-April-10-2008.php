...
$htmlTitle = 'CreditCards.com: Weekly Credit Card Rate Report - April 10, 2008 - CreditCards.com';
...
<div class="other-block">
	<div class="container">
		<div class="row">
			...
			<p><span class="press-release-date">April 10, 2008</span></p>

			<h1>CreditCards.com: Weekly Credit Card Rate Report</h1>

			<p>Austin, Texas - Annual percentage rates for select major  credit card categories were mostly unchanged to lower this week, as Federal  Reserve minutes revealed internal disagreement about the size of last month's three-quarter  point interest rate cut.</p>
			...
			<p>"With the uncertainties in the outlook for both  economic activity and inflation elevated, members noted that appropriately  calibrating the stance of policy was difficult" because it would take time  to see the effect of earlier rate cuts, the Fed said in the minutes of its March  18 meeting. The Dallas and Philadelphia Fed bank presidents opposed the rate  cut, preferring less aggressive moves. </p>
			<p>Retailers posted weak March sales as consumers  restricted their purchases to food and other non-discretionary purchases. The Fed  also reported a slowdown in credit card use during February. </p>
