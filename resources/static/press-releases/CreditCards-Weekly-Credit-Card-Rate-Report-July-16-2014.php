...
$htmlTitle = 'CreditCards.com: Weekly Credit Card Rate Report - July 16, 2014 - CreditCards.com';
...
$metaDescription = 'Interest rates on new card offers held steady this week, according to the CreditCards.com Weekly Credit Card Rate Report';
...
<div class="other-block">
	<div class="container">
		<div class="row">
			...
			<p><span class="press-release-date">July 16, 2014</span></p>

			<h1><strong>CreditCards.com Weekly Credit Card Rate Report:  Average card rates remain at 15.03 percent.</strong></h1>

			<p>Austin, Texas&mdash;Interest rates on new card  offers held steady this week, according to the CreditCards.com Weekly Credit  Card Rate Report. </p>
			...
			<p>The national average annual  percentage rate (APR) stayed put at 15.03 percent Wednesday after increasing  incrementally for two consecutive weeks.</p>
			<p>None of the cards tracked by  CreditCards.com introduced new terms this week. Issuers left promotional  balance transfer offers and introductory APRs alone as well.</p>
			<p>Most card issuers have left  interest rates alone throughout 2014. Over the past few months, Chase has  gradually increased APRs on a handful of travel rewards cards, including the United  MileagePlus Explorer card, the Southwest Airlines Rapid Rewards Plus card, the  IHG Rewards Club Select card and the Marriott Rewards Visa Signature card.</p>
			<p>The few times that APRs have  changed, they've usually gone up. Since Jan. 1, for example, the national  average has increased five times and declined twice.</p>
