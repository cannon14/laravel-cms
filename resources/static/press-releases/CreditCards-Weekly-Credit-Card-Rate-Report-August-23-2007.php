...
$htmlTitle = 'CreditCards.com: Weekly Credit Card Rate Report';
...
<div class="other-block">
	<div class="container">
		<div class="row">
			...
			<p><span class="press-release-date">Thursday, August 23, 2007</span></p>

			<h1>CreditCards.com: Weekly Credit Card Rate Report</h1>

			<p>Austin, Texas - Credit card interest rates remained flat this week across all popular card categories, as speculation of a pending prime rate movement by the Federal Reserve continues amid conflicting opinions by experts.</p>
			<p>Potential prime rate increases are noteworthy to those cardholders that revolve balances each month because a majority of banks base their variable credit card APRs on an index tied to the prime rate. According the central bank, 54% of card issuers utilize the prime rate as their lending benchmark.</p>
			...
			<p>Despite the recent issues surrounding the subprime mortgage market, the supply of consumer installment credit has remained relatively constant, according to the Federal Reserve's July 2007 Senior Loan Officer Survey on Bank Lending Practices. Of the 32 large banks surveyed, only one lender tightened its standards for consumer loans, while two reported loosening standards somewhat. The remaining 29 left their standards unchanged.</p>
