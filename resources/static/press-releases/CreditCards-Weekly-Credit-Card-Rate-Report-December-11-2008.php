...
$htmlTitle = 'CreditCards.com: Weekly Credit Card Rate Report - December 11, 2008 - CreditCards.com';
...
$metaDescription = 'Banks maintained annual percentage rates on new credit card offers this week, according to the CreditCards.com Weekly Credit Card Rate Report.';
...
<div class="other-block">
	<div class="container">
		<div class="row">
			...
			<p><span class="press-release-date">December 11, 2008</span></p>

			<h1>CreditCards.com: Weekly Credit Card Rate Report</h1>

			<p>Austin, Texas -- Banks maintained annual percentage rates on  new credit card offers this week, according to the CreditCards.com Weekly  Credit Card Rate Report. However, APRs tracked by the Web site largely declined,  due to a change in the composition of card offers. &nbsp;&nbsp;</p>
			<p>Of the nine credit card categories tracked by  CreditCards.com, six declined, two increased and one was unchanged. </p>
			...
			<p>Card issuers kept APRs steady ahead of an expected Federal  Reserve rate cut on Tuesday. If the Fed decides to further lower its key  lending rate in an effort to bolster a troubled economy, banks could follow  suit by trimming APRs on their variable rate credit cards, which are often tied  to the prime rate. &nbsp;&nbsp; </p>
			<p>Analysts believe next week the Fed will cut rates by at  least half a percent -- from 1 percent to 0.5 percent. The latest economic news  will likely strengthen support for such action. Initial jobless claims reached  a 26-year high last week, far surpassing economist's predictions. That report  suggests declining payrolls and rising unemployment continued into December. </p>
