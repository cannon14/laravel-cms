...
$htmlTitle = 'CreditCards.com: Weekly Credit Card Rate Report - August 21, 2008 - CreditCards.com';
...
$metaDescription = 'Annual percentage rates for new credit card offers were mostly steady this week, according to the CreditCards.com Weekly Credit Card Rate Report.';
...
<div class="other-block">
	<div class="container">
		<div class="row">
			...
			<p><span class="press-release-date">August 21, 2008</span></p>

			<h1>CreditCards.com: Weekly Credit Card Rate Report</h1>

			<p>Austin, Texas -- Annual percentage rates for new credit  card offers were mostly steady this week, according to the CreditCards.com  Weekly Credit Card Rate Report.</p>
			<p>Banks were content to leave rates unchanged this week,  after data showed wholesale prices may have peaked last month and a key  regulator warned of inflationary challenges. Of the nine credit card categories  tracked by CreditCards.com, only cash back and reward cards posted rate declines,  while the remainder were unchanged. </p>
			...
			<p>July wholesale prices climbed at the fastest annual pace  in 27 years, although the recent drop in energy prices could signal a peak in  the prices businesses pay for goods. </p>
			<p>Meanwhile, Dallas Fed President Richard Fisher acknowledged  in a speech that while slowing economic growth may be helping dampen inflation,  the Fed &quot;must remain poised to act&quot; if that changes. Still, it's  believed that the Fed could leave a key short-term interest rate unchanged for  the balance of 2008. That means an unchanged prime rate, which banks use to set  APRs on variable rate cards.</p>
