...
$htmlTitle = 'CreditCards.com: Weekly Credit Card Rate Report - August 21, 2013 - CreditCards.com';
...
<div class="other-block">
	<div class="container">
		<div class="row">
			...
			<p><span class="press-release-date">August 21, 2013</span></p>

			<h1><strong>CreditCards.com Weekly Credit Card Rate Report:  Credit card interest rates remain at 14.95 percent</strong></h1>

			<p>Austin, Texas&mdash;Average rates on new credit card offers remained  at 14.95 percent Wednesday, according to the CreditCards.com Weekly Credit Card  Rate Report.</p>
			...
			<p>Issuers left interest rates alone this week. However, not  all credit card terms remained the same.</p>
			<p>American Express, for example, lengthened the promotional  APR period on three of its flagship credit cards: the Blue Cash Everyday card,  the Blue Sky card and the Blue card. Applicants for all three cards may now  qualify for a 0 percent APR on purchases for up to 15 months. The issuer also  introduced a 15-month, 0 percent balance transfer offer to each card.</p>
			<p>Barclays, meanwhile, canceled a test offer on the US Airways  Premier World MasterCard. The issuer eliminated the card's 12-month  introductory APR after introducing the offer last week. In addition, Barclays  extended the World MasterCard's 0 percent balance transfer period from 12  months to 15 months.</p>
