...
<head>
    ...
    $htmlTitle = 'CreditCards.com: Weekly Credit Card Rate Report - July 29, 2015 - CreditCards.com';
    ...
    $metaDescription = 'Interest rates on new credit card offers were left unchanged again this week, according to the CreditCards.com Weekly Credit Card Rate Report.';
...
<div class="other-block">
    <div class="container">
        <div class="row">
            ...
            <p> <span class="dateCol">Wednesday, July 29, 2015</span> </p>
            <h1><strong>CreditCards.com Weekly Credit Card Rate Report: Average card rates remain stuck at 15 percent</strong></h1>
            <p> Austin, Texas
                &mdash;
            ...
            <p>&nbsp;</p>
            <p>None of the issuers tracked by CreditCards.com adjusted interest rates. As a result, the national average APR remained lodged at 15 percent for the sixth consecutive week.</p>
            <p>Promotional rates, including 0 percent purchase rates and interest-free balance transfer offers, were also left unchanged.</p>
            <p>Issuers have mostly left credit card terms alone this summer. The last time a card tracked by CreditCards.com advertised a new promotional rate was in early June when Discover trimmed the "it" card's interest-free purchase and balance transfer offer from 15 months to 12 months. Interest rates have also largely stayed the same. The national average APR, for example, has changed just twice since the beginning of May.</p>
