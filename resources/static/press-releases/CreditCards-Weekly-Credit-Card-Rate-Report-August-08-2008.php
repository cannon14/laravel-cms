...
$htmlTitle = 'CreditCards.com: Weekly Credit Card Rate Report - August 08, 2008 - CreditCards.com';
...
$metaDescription = 'Annual percentage rates for select major credit card categories were largely unchanged this week, although APRs for low interest and student credit cards posted notable increases.';
...
<div class="other-block">
	<div class="container">
		<div class="row">
			...
			<p><span class="press-release-date">August 08, 2008</span></p>

			<h1>CreditCards.com: Weekly Credit Card Rate Report</h1>

			<p>Austin, Texas -- Annual percentage rates for student  credit cards dropped more than three-quarters of a percent this week, spurred  by Discover's lowering of rates in that category, according to the  CreditCards.com Weekly Credit Card Rate Report. </p>
			<p>A Discover spokesman said the company was simply enhancing  its offer when it dropped its regular APR from 16.99 to 14.99 percent for  student cards, driving the whole category lower. </p>
			<p>Of the nine credit card categories tracked by  CreditCards.com, five saw rates decline, three remained unchanged and one rose.  This follows a key decision by the Federal Reserve this week. Caught between  threats from inflation and recession, the Fed left a key short-term interest  rate unchanged at 2 percent. That means an unchanged prime rate, which banks  use to set APRs on variable rate cards.</p>
			...
			<p>Still, the Fed provided itself with flexibility going  forward. "The Committee will continue to monitor economic and financial  developments and will act as needed to promote sustainable economic growth and  price stability," the Fed said, suggesting rate increases and decreases  remain possible. </p>
			<p>The CreditCards.com credit card rate survey is conducted  weekly using data from the leading U.S. card issuers. Rate movement may also be  influenced by changes in the composition of offers tracked. </p>
