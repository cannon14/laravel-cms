...
$htmlTitle = 'CreditCards.com: Weekly Credit Card Rate Report - July 24, 2008 - CreditCards.com';
...
$metaDescription = 'Annual percentage rates for select major credit card categories were mixed to lower this week, as the Federal Reserve is expected to leave interest rates unchanged for the remainder of 2008 amid challenges posed by both economic weakness and inflation.';
...
<div class="other-block">
	<div class="container">
		<div class="row">
			...
			<p><span class="press-release-date">July 24, 2008</span></p>

			<h1>CreditCards.com: Weekly Credit Card Rate Report</h1>

			<p>Austin, Texas -- Annual percentage rates for select major  credit card categories fell this week, as the latest economic data continues to  leave the Federal Reserve in wait-and-see mode regarding interest rates. The  Fed is expected to maintain rates at 2 percent when it next meets on Aug.  5.</p>
			<p>According to the Fed, 57 percent of banks index their  credit card APRs to the prime rate, with most adjusting variable rates 30 days  or one billing cycle after the prime rate changes. </p>
			...
			<p>The Fed&rsquo;s latest beige book survey indicated that &ldquo;the pace  of economic activity slowed somewhat since the last report,&rdquo; with consumer  spending described as &ldquo;sluggish or slowing&rdquo; in nearly all of the 12 regional Fed  bank districts. In the Atlanta region, some businesses acknowledged using credit  cards to cover expenses amid the challenging economy. </p>
			<p>Meanwhile, despite recent discussion of inflation threats  from soaring energy and food prices, a moderate pullback in oil prices over the  past two weeks could reduce pressure on the Fed to raise interest rates. &nbsp;</p>
