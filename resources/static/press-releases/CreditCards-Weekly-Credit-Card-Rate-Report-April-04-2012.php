...
$htmlTitle = 'CreditCards.com: Weekly Credit Card Rate Report - April 4, 2012 - CreditCards.com';
...
<div class="other-block">
	<div class="container">
		<div class="row">
			...
			<p><span class="press-release-date">April 4, 2012</span></p>

			<h1>CreditCards.com: Weekly Credit Card Rate Report</h1>

			<p>Austin, Texas &mdash; Credit card interest rates dipped on Wednesday, according to  the CreditCards.com Weekly Credit Card Rate Report. </p>
			...
			<p>The average annual percentage rate (APR) fell to 14.96  percent. This is the fifth time this year rates have declined. However, unlike  previous changes, this week&rsquo;s rate change was due to a reshuffling of the  CreditCards.com database. </p>
			<p>Occasionally, CreditCards.com adjusts the database in order  to more accurately reflect the credit card market. This week, we removed four  cards that were no longer available online and replaced them with an equal  number of similar credit cards. One of the new cards &mdash; the True Earnings credit  card from Costco and American Express &mdash; featured av lower APR than its  predecessor, the Citi Platinum CITGO MasterCard. As a result, the national  average declined slightly. </p>
			<p>Average APRs for rewards credit cards and balance transfer cards were also affected by the change.</p>
