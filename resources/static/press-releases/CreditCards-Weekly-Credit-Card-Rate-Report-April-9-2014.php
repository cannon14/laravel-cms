...
$htmlTitle = 'CreditCards.com: Weekly Credit Card Rate Report - April 9, 2014 - CreditCards.com';
...
$metaDescription = 'Average rates on new credit card offers ticked up this week, according to the CreditCards.com Weekly Credit Card Rate Report.';
...
<div class="other-block">
	<div class="container">
		<div class="row">
			...
			<p><span class="press-release-date">April 9, 2014</span></p>

			<h1><strong>CreditCards.com Weekly Credit Card Rate Report:  Credit card interest rates rise to 15.02 percent</strong></h1>

			<p>Austin, Texas&mdash;Average rates on new credit card offers ticked up this week,  according to the CreditCards.com Weekly Credit Card Rate Report.</p>
			...
			<p>The national average annual percentage rate (APR) rose to  15.02 percent Wednesday after Chase revised the terms on one of its travel  rewards credit cards.</p>
			<p>Chase increased the APR on the Disney Rewards Visa card by 1  percentage point, pushing it up from a single APR of 14.24 percent to a flat  rate of 15.24 percent. Chase left the card's promotional APR alone. Cardholders  who vacation at a Disney theme park still have 6 months to make interest-free  purchases.</p>
			<p>Pentagon Federal Credit Union was also active this week. The  credit union removed the 18-month 0 percent balance transfer offer on the  PenFed Platinum Cash Rewards Standard card and replaced it with a low-rate  offer of 4.99 percent for 48 months.</p>
