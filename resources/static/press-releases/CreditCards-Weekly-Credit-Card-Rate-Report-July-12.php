...
$htmlTitle = 'CreditCards.com: Weekly Credit Card Rate Report - July 12, 2007 - CreditCards.com';
...
<div class="other-block">
	<div class="container">
		<div class="row">
			...
			<p><span class="press-release-date">July 12, 2007</span></p>

			<h1>CreditCards.com: Weekly Credit Card Rate Report</h1>

			<p>AUSTIN, Texas--(BUSINESS WIRE)--Credit card interest rates held firm this week, as the Federal Reserve sticks to its wait-and-see approach to monetary policy, seeing little reason to change rates. With the prime rate apparently set for the time being, widespread changes to credit card rates do not appear imminent.
			</p>
			<p>
			Students still pay the highest credit card average percentage rates (APRs).
			</p>
			<p>
			...
			<p>
			In a speech this week, Federal Reserve Chairman Ben Bernanke noted that inflation should not pose a problem if expectations remain unruffled by movement in volatile food and energy prices. Bernanke explained that unlike in the U.S. of the 1970s, steep gains in energy prices over recent years have not produced ongoing inflation or recession.
			</p>
			<p>
			Amid this environment, it appears unlikely that the Fed will move to change monetary policy at its August 7 meeting, which means any rate changes that consumers see are due to the actions of the card issuers, not the Fed.
			</p>
			<p>
