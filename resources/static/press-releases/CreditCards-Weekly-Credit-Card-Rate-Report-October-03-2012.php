...
$htmlTitle = 'CreditCards.com: Weekly Credit Card Rate Report - October 3, 2012 - CreditCards.com';
...
$metaDescription = 'Interest rates on new credit card offers remained at 15 percent on Wednesday, according to the CreditCards.com Weekly Credit Card Rate Report.';
...
<div class="other-block">
	<div class="container">
		<div class="row">
			...
			<p><span class="press-release-date">October 3, 2012</span></p>

			<h1>CreditCards.com: Weekly Credit Card Rate Report</h1>

			<p>Austin, Texas&mdash;Interest rates on new credit card offers remained at 15  percent on Wednesday, according to the CreditCards.com Weekly Credit Card Rate  Report.<br><br>
			...
			<p>This week marks the third straight week that the national  average annual percentage rate (APR) on new card offers has hit 15 percent. </p>
			<p>None of the cards featured significant rate changes this  week. However, one issuer, the Pentagon Federal Credit Union, introduced a  unique offer to each of its cards. Qualified applicants that apply for any  PenFed credit card, such as the PenFed Visa Platinum Cash Rewards card, will  now be able to make interest-free purchases on electronics for six months.</p>
			<p>The issuer added the offer as a supplement to its existing  promotional offers, rather than as a replacement. For example, applicants that  apply for the PenFed Promise card will also still qualify for an introductory  APR of 7.49 percent for 36 months.</p>
