...
$htmlTitle = 'CreditCards.com: Weekly Credit Card Rate Report - July 5, 2013 - CreditCards.com';
...
<div class="other-block">
	<div class="container">
		<div class="row">
			...
			<p><span class="press-release-date">July 5, 2013</span></p>

			<h1><strong>CreditCards.com Weekly Credit Card Rate Report:  Credit card interest rates hold steady at 14.96 percent</strong></h1>
			...
			<p>The national average annual percentage rate (APR) remained  at 14.96 percent Wednesday for a second week.</p>
			<p>Most credit card issuers left interest rates and promotional  terms, such as 0 percent balance transfer offers, alone this week.</p>
			<p>One issuer -- the sporting goods store Cabela's &mdash; raised the  maximum available APR on its credit card for club members by 3 percentage  points. The rate hike didn't affect the national average, however, because  CreditCards.com considers only a card's lowest available rate when calculating  average interest rates.</p>
			<p>Cabela's increased the maximum APR on the Cabela's Club Visa  card from 18.18 percent to 21.19 percent. Cabela's left the card's minimum rate  of 9.99 percent alone.</p>
