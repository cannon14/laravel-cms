...
$htmlTitle = 'CreditCards.com: Weekly Credit Card Rate Report - December 3, 2014 - CreditCards.com';
...
$metaDescription = 'Average rates on new credit card offers declined slightly this week, according to the CreditCards.com Weekly Credit Card Rate Report.';
...
<div class="other-block">
	<div class="container">
		<div class="row">
			...
			<p><span class="press-release-date">December 3, 2014</span></p>

			<h1><strong>CreditCards.com Weekly Credit Card Rate Report: Average  card rates dip to 14.95 percent</strong></h1>

			<p>Austin, Texas&mdash;Average rates on new credit card  offers declined slightly this week, according to the CreditCards.com Weekly  Credit Card Rate Report.
			</p>
			...
			<p>
			Issuers did not make any promotional  rate or annual fee changes this week.
			</p>
			<p>
			Average rates are still at  their lowest since September 2013, when the national average hit 14.99 percent.  The 2014 national average APR is 15.03 percent.
			</p>
			The CreditCards.com credit card rate survey  (permalink:
			<a href="http://www.creditcards.com/rate-report">
			http://www.creditcards.com/rate-report
			</a>
			) is conducted weekly, using offer data from the  leading U.S. card issuers' websites. Introductory offer periods and regular  interest rates will vary with applicants' credit quality and issuer risk-based  pricing policies.
