...
$htmlTitle = 'CreditCards.com: Weekly Credit Card Rate Report - May 6, 2015 - CreditCards.com';
...
$metaDescription = 'Interest rates on new card offers remain locked in place this week, according to the CreditCards.com Weekly Credit Card Rate Report.';
...
<div class="other-block">
	<div class="container">
		<div class="row">
			...
			<p><span class="press-release-date">May 6, 2015</span></p>

			<h1><strong>CreditCards.com Weekly Credit Card Rate Report: Average  card rates remain unchanged</strong></h1>

			<p>Austin, Texas&mdash;Interest rates on new card  offers remain locked in place this week, according to the CreditCards.com  Weekly Credit Card Rate Report.</p>
...
<p>Rates for card categories tracked by CreditCards.com  are listed below:</p>
			...
			<p>The national average annual percentage rate (APR) remained at 14.92 percent Wednesday after issuers left  card APRs alone for the second week in a row. Promotional terms, including 0  percent APRs and balance transfer offers, were also left untouched.</p>
			<p>Average rates on new card  offers are relatively low these days compared to the past three years, thanks  to a string of rate changes that occurred in late 2014 and the first quarter of  2015. After remaining at or above 15 percent for more than a year, the national  average APR began declining intermittently in November before hitting a nearly  three-year low of 14.87 percent earlier this year. Rates have inched up  somewhat since, but are still significantly lower than they were for most of  2014.</p>
