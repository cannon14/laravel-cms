...
$htmlTitle = 'CreditCards.com: Weekly Credit Card Rate Report - June 25, 2014 - CreditCards.com';
...
$metaDescription = 'Interest rates on new card offers remained locked in place this week, according to the CreditCards.com Weekly Credit Card Rate Report.';
...
<div class="other-block">
	<div class="container">
		<div class="row">
			...
			<p><span class="press-release-date">June 25, 2014</span></p>

			<h1><strong>CreditCards.com Weekly Credit Card Rate Report:  Average card rates remain at 15.01 percent for 8th week</strong></h1>

			<p>Austin, Texas&mdash;Interest rates on new card  offers remained locked in place this week, according to the CreditCards.com  Weekly Credit Card Rate Report. </p>
			...
			<p>The national average annual  percentage rate (APR) remained fixed at 15.01 percent Wednesday for the 8th  consecutive week. </p>
			<p>Credit card issuers have been  slow to change card terms for most of 2014. For example, it's been nearly two  months since the last time a credit card issuer revised the APR on a card tracked  by CreditCards.com. Meanwhile, the national average APR has changed just five  times since Jan. 1. Issuers left promotional terms unchanged this week as well.</p>
			<p>Chase did remove several  cards from its promotional pages this week, including the Sapphire card.  However, it left the cards' premium versions, such as the Sapphire Preferred  card, alone. It's not yet clear whether the cards will eventually return. </p>
