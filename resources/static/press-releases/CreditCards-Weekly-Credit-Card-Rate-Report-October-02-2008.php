...
$htmlTitle = 'CreditCards.com: Weekly Credit Card Rate Report - October 02, 2008 - CreditCards.com';
...
$metaDescription = 'Annual percentage rates for new credit card offers lacked a clear direction this week, according to the CreditCards.com Weekly Credit Card Rate Report, as HSBC and Capital One tweaked some of their card offers.';
...
<div class="other-block">
	<div class="container">
		<div class="row">
			...
			<p><span class="press-release-date">October 02, 2008</span></p>

			<h1>CreditCards.com: Weekly Credit Card Rate Report</h1>

			<p>Austin, Texas -- Annual percentage rates for new credit  card offers lacked a clear direction this week, according to the  CreditCards.com Weekly Credit Card Rate Report, as HSBC and Capital One tweaked  some of their card offers. </p>
			<p>Of the nine credit card categories tracked by  CreditCards.com, three increased, four fell and two remained flat. </p>
			...
			<p>In a potential turnaround from an earlier focus on  inflation, analysts speculate the Fed may decide to further trim interest rates  amid recession fears and turmoil in the financial sector, even if Congress  passes a $700 billion economic stabilization plan. Such Fed action would lower  the prime rate, which banks use to set APRs on variable rate cards.&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;<br>
			&nbsp;<br>
			Supporting that potential move, data showed manufacturing  activity slid to its lowest level since October 2001 and indicated contraction  in that sector. A report today revealed weekly jobless claims remained at their  highest level in seven years, with a broader snapshot of the job market due out  tomorrow in the form of September's employment report. &nbsp;</p>
