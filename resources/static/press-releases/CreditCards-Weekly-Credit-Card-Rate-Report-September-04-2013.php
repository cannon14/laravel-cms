...
$htmlTitle = 'CreditCards.com: Weekly Credit Card Rate Report - September 4, 2013 - CreditCards.com';
...
<div class="other-block">
	<div class="container">
		<div class="row">
			...
			<p><span class="press-release-date">September 4, 2013</span></p>

			<h1><strong>CreditCards.com Weekly Credit Card Rate Report:  Credit card interest rates rise to 14.99 percent</strong></h1>
			...
			<p>The national average annual percentage rate (APR) climbed to  14.99 percent Wednesday, after hovering between 14.95 percent and 14.96 percent  for 13 weeks. This is the first time since 2012 that the national average has  risen above 14.98 percent.</p>
			<p>Unlike previous rate changes, however, this week&rsquo;s change was  spurred by a reshuffling of cards in the CreditCards.com database, rather than by  a new APR on an existing card. Occasionally, CreditCards.com swaps out cards  that have been discontinued or taken offline by issuers and replaces them with  similar offers.</p>
			<p>This week, CreditCards.com removed a number of cards that  were no longer being promoted online, including the Citi Gold Aadvantage Visa  Signature card and the BankAmericard Power Rewards Visa Signature card.</p>
