...
$htmlTitle = 'CreditCards.com: Weekly Credit Card Rate Report - October 16, 2008 - CreditCards.com';
...
$metaDescription = 'Annual percentage rates fell slightly for most credit cards, according to the CreditCards.com Weekly Credit Card Rate Report, as Citi this week lowered APRs on many of its cards in reaction to the Federal Reserve\'s recent rate cut.';
...
<div class="other-block">
	<div class="container">
		<div class="row">
			...
			<p><span class="press-release-date">October 16, 2008</span></p>

			<h1>CreditCards.com: Weekly Credit Card Rate Report</h1>

			<p>Austin, Texas -- Annual percentage rates fell  slightly for most credit cards, according to the CreditCards.com Weekly Credit  Card Rate Report, as Citi this week lowered APRs on many of its cards in  reaction to the Federal Reserve's recent rate cut. </p>
			<p>Of the nine credit card categories tracked by  CreditCards.com, six fell and three advanced. </p>
			...
			<p>In the wake of the Fed's decision last week to lower the fed  funds rate, Citi lowered APRs on some of its variable rate credit cards, which are  tied to a prime rate that typically follows the Fed's benchmark rate. With its  announcement today of a third-quarter loss, Citi became the latest U.S. bank to  acknowledge rising card delinquencies. Citi's global credit card business lost  money as the division's sales tumbled 40 percent. </p>
			<p>That wasn't the only troubling economic news. A massive  decline in retail sales for September suggests that credit card transactions  are on the downswing, while the Fed's Beige Book economic report showed that activity slowed  across all 12 metropolitan regions surveyed. </p>
