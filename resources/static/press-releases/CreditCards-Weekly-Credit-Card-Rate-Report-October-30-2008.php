...
$htmlTitle = 'CreditCards.com: Weekly Credit Card Rate Report - October 30, 2008 - CreditCards.com';
...
$metaDescription = 'Annual percentage rates for credit cards were mostly unchanged, according to the CreditCards.com Weekly Credit Card Rate Report, as issuers left APRs alone despite a Federal Reserve rate cut.';
...
<div class="other-block">
	<div class="container">
		<div class="row">
			...
			<p><span class="press-release-date">October 30, 2008</span></p>

			<h1>CreditCards.com: Weekly Credit Card Rate Report</h1>

			<p>Austin, Texas -- Annual percentage rates for credit  cards were mostly unchanged, according to the CreditCards.com Weekly Credit  Card Rate Report, as issuers left APRs alone despite a Federal Reserve rate cut.</p>
			<p>Of the nine credit card categories tracked by  CreditCards.com, two declined and seven held steady. </p>
			...
			<p>On Wednesday, the Fed cut its key lending rate by half a  percentage point to 1 percent. However, analysts say the decision may only  provide APR relief to cardholders of the highest credit quality with certain  variable-rate cards from issuers that have not imposed &quot;floors&quot; on  how low rates can fall. For example, Bank of America, which does not set floors,  told CreditCards.com that variable rates based on prime will eventually drop due  to the Fed's move. </p>
			<p>Regardless of the benefit to cardholders, additional rate  cuts could follow, with the Fed saying it will &quot;act as needed&quot; to encourage  economic growth and stable prices. Those cuts could be necessary: third-quarter  gross domestic product data released Thursday showed contraction amid the worst  consumer spending since 1980. &nbsp;&nbsp;&nbsp;&nbsp;</p>
