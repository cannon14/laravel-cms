...
<div class="other-block">
	<div class="container">
		<div class="row">
			...
			<p><span class="press-release-date">October 22, 2014</span></p>

			<h1><strong>CreditCards.com Weekly Credit Card Rate Report: Average card rates linger at 15.07 percent</strong></h1>

			<p>Austin, Texas&mdash;
