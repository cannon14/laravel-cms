...
$htmlTitle = 'CreditCards.com: Weekly Credit Card Rate Report - February 29, 2012 - CreditCards.com';
...
$metaDescription = 'The average interest rate on a new credit card offers fell to its lowest level in more than eight months, according to the CreditCards.com Weekly Credit Card Rate Report.';
...
<div class="other-block">
	<div class="container">
		<div class="row">
			...
			<p><span class="press-release-date">February 29, 2012</span></p>

			<h1>CreditCards.com: Weekly Credit Card Rate Report</h1>

			<p>Austin, Texas&mdash;The average interest rate on a new credit card offers fell to  its lowest level in more than eight months, according to the CreditCards.com  Weekly Credit Card Rate Report.</p>
			<p>
			The average is composed of 100 of the most popular credit  cards in the country, including cards from dozens of leading U.S. issuers  and representing every card category. Introductory (teaser) rates are not  included in the calculation. Out of the nine categories CreditCards.com tracks,  two fell and seven remained unchanged.</p>
			...
			<p>This week, the average annual  percentage rate (APR) dropped to 14.87 percent -- the lowest it has been since  June 2011. It's the third time this year that rates have dropped. They  have not risen since mid-December, a record span of 12 weeks without an  increase. </p>
			<p>The decrease was spurred by Barclays' change to its Carnival  World MasterCard. The card had carried an APR range of 13.99 percent to 20.99  percent. The new offer for that card is 10.74 percent to 21.74 percent, which  forced the national APR average lower. </p>
			<p>Barclay's spokesman Kevin Sullivan confirmed the change.</p>
