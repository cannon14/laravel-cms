...
$htmlTitle = 'CreditCards.com: Weekly Credit Card Rate Report - April 14, 2010 - CreditCards.com';
...
$metaDescription = 'Interest rates on new credit card offers fell this week, according to the CreditCards.com Weekly Credit Card Rate Report, after several card products saw their rates adjusted.';
...
<div class="other-block">
	<div class="container">
		<div class="row">
			...
			<p><span class="press-release-date">April  14, 2010</span></p>

			<h1>CreditCards.com: Weekly Credit Card Rate Report</h1>

			<p>Austin, Texas &mdash; Interest rates on new credit card offers fell this week,  according to the CreditCards.com Weekly Credit Card Rate Report, after rates  were adjusted on several card products.</p>
			<p>The average is comprised of about 95 of the most popular  credit cards in the country, including cards from dozens of leading U.S. issuers  and representing every card category listed below. Introductory (teaser) rates  are not included in the calculation. Among the nine card categories, average annual  percentage rates (APRs) declined in three, rose in one and were unchanged in five.&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;</p>
			...
			<p>Chase said its latest changes -- reducing the lower end of the  Slate card's APR range and increasing the Priority Club Rewards Visa card's  rate -- stem from a variety of factors. While Chase didn't identify those  factors, many other banks have pointed to economic challenges and the Credit  CARD Act, which restricts rate increases on existing plastic but doesn't limit APRs  for new offers.&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;</p>
			<p>The Golf Magazine Rewards Visa card, meanwhile, changed from  a single rate to an APR range, enabling issuer PartnersFirst to better price  for risk. </p>
