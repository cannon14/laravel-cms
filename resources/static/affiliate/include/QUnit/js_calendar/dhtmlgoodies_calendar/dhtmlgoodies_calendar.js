...
function highlightSelect()
{
	if(this.className=='selectBox'){
		...
		this.getElementsByTagName('IMG')[0].src = './templates/csaStyle1/images/calimages/down_over.gif';
	}else{
		this.className = 'selectBox';	
		this.getElementsByTagName('IMG')[0].src = './templates/csaStyle1/images/calimages/down.gif';			
	}
...
function highlightArrow()
{
	if(this.src.indexOf('over')>=0){
		if(this.src.indexOf('left')>=0)this.src = './templates/csaStyle1/images/calimages/left.gif';	
		if(this.src.indexOf('right')>=0)this.src = './templates/csaStyle1/images/calimages/right.gif';				
	}else{
		if(this.src.indexOf('left')>=0)this.src = './templates/csaStyle1/images/calimages/left_over.gif';	
		if(this.src.indexOf('right')>=0)this.src = './templates/csaStyle1/images/calimages/right_over.gif';	
	}
}
...
{
	if(this.src.indexOf('over')>=0){
		this.src = './templates/csaStyle1/images/calimages/close.gif';
	}else{
		this.src = './templates/csaStyle1/images/calimages/close_over.gif';	
	}	
...
function writeTopBar()
{
	...
	img.src = './templates/csaStyle1/images/calimages/left.gif';
	...
	var img = document.createElement('IMG');
	img.src = './templates/csaStyle1/images/calimages/right.gif';
	img.onclick = switchMonth;
	img.onmouseover = highlightArrow;
	img.onmouseout = highlightArrow;
	...
	var img = document.createElement('IMG');
	img.src = './templates/csaStyle1/images/calimages/down.gif';
	...
	var img = document.createElement('IMG');
	img.src = './templates/csaStyle1/images/calimages/close.gif';
	img.style.styleFloat = 'right';
