...
define("WSDL_SERVER_ADDRESS", "http://feeds.creditcards.com:8535/cardquery/QueryService?wsdl");

//define("WSDL_SERVER_ADDRESS", "http://cc120.aus.creditcards.com:8535/cardquery/QueryService?wsdl");
//define("WSDL_SERVER_ADDRESS", "http://lindev02.inside.cs:8080/cardquery/QueryService?wsdl");
//define("WSDL_SERVER_ADDRESS", "http://lindev04.in.creditcards.com:8080/cardquery/QueryService?wsdl");
...
class CardQuery {
	...
	public static function getCardById($cardId) {
		...
		try {
			$client = new SoapClient(WSDL_SERVER_ADDRESS);
		} catch (Exception $e) {
			return false;
		}
	...
	public static function getCreditCardsByExpression($expression) {
