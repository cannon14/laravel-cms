...
class Affiliate_Merchants_Views_ArticleSubCategoryManager extends QUnit_UI_ListPage
{
...
//        $this->modulePermissions['view'] = 'aff_trans_transactions_view';
	...
	function drawFormEditCat(){
		...
		$this->addContent('articlecat_create');
    ...
    {   
        ...
        Affiliate_Merchants_Bl_Articles::updateArticle($id, $params);
        
        QUnit_Messager::setOkMessage("Article Sub Heading Successfully Created");  
    ...
    {   
		...
		$id = Affiliate_Merchants_Bl_Articles::addArticle($params);
    ...
    function processDelete()
    {
		...
		$sql = "UPDATE rt_articles SET deleted = 1 WHERE id in " . $sqlEIDs;
       	echo $sql;
    ...
    function showTransactions($exportToCsv)
    {
        ...
        $this->addContent('articlecat_list');        
    }    
