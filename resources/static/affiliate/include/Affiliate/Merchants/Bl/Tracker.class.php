...
class Affiliate_Merchants_Bl_Tracker
{
    ...
    function getTrackersAsArray()
    {
    	
        $sql = 'select * from rt_trackers t where t.deleted=0 order by trackerName';
        $rs = QCore_Sql_DBUnit::execute($sql, __FILE__, __LINE__);
        ...
        while(!$rs->EOF)
        {
            ...
            $thisList[$rs->fields['trackerId']] = $temp;
