    ...
    <tr>
        <td class=actionheader align=left>
          <? if($this->a_action_permission['view']) { ?>
            <b><a class=mainlink href="javascript:createSite()">Create New Card Sub Category </a> | <a class=mainlink href="javascript:FilterForm.action.value='exportcsv'; FilterForm.submit();"><?=L_G_EXPORTTOCSV?></a></b>
          <? } ?>
        </td>
    </tr>    
    <tr>
        ...
        <tr>
            <td class=listViewLine>
                <? $this->a_this->printAvailableViews('Affiliate_Merchants_Views_CardSubCategoryManager'); ?>
            </td>
        </tr>
        </table>
