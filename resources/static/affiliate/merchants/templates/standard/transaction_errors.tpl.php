<? 
include('transaction_errors_filter.tpl.php');
...
<? } ?>
   ...
   <? QUnit_Templates::printFilter(10, "Error Log"); ?> 
    <tr>
    ...
    <tr>
        ...
        <tr>
            <td class=listViewLine>
                <? $this->a_this->printAvailableViews('Affiliate_Merchants_Views_TransactionErrors'); ?>
            </td>
        </tr>
        </table>
