<?
include('ccgroups_filter.tpl.php');
?>
...
<? } ?>
    ...
    <? QUnit_Templates::printFilter(1,"Product Groups"); ?>
    <tr>
        <td class=actionheader align=left>
          <? if($this->a_action_permission['add']) { ?>
            <b><a class=mainlink href="javascript:addUser();">Add Group</a></b>
            &nbsp;&nbsp;|&nbsp;&nbsp;
          <? } ?>
    ...
    <tr>
        ...
        <tr>
            <td class=listViewLine>
                <? $this->a_this->printAvailableViews('Affiliate_Merchants_Views_CampaignCategoryGroupsManager'); ?>
            </td>
        </tr>
        </table>
