...
<? if($this->a_action_permission['add']) { ?>
    <tr>
       <td class=actionheader align=left colspan=10><b><a class=mainlink href="javascript:addCampaign();"><?=L_G_ADDCAMPAIGN?></a></b></td>
    </tr>
<? } ?>
    <tr>
    ...
    <tr>
      <td class=listheader colspan=10 align=center><?=L_G_LISTOFCAMPAIGNS?>&nbsp;<? print " ( ".L_G_ROWS.": ".$this->a_numrows." )"; ?></td>
     </tr>
    <tr class=listheader>
<?
      QUnit_Templates::printHeader(L_G_ID, 'campaignid');
      QUnit_Templates::printHeader(L_G_NAME, 'name');
      QUnit_Templates::printHeader('Merchant Name', 'short_name');
...
?>
    <tr class=listresult class=row onMouseover="this.className='listresultMouseOver'" onMouseOut="this.className='listresult';">
      <td class=listresult>&nbsp;<?=$data['bannerid']?>&nbsp;</td>
      <td class=listresultnocenter align=left nowrap>&nbsp;<?=$data['name']?>&nbsp;</td>
      <td class=listresult>&nbsp;<?=(isset($data['merchant_name']) ? $data['merchant_name'] : '<font color="red">No Merchant Set</font>')?>&nbsp;</td>
