...
function addExpense()
{
	var wnd = window.open("index_popup.php?md=Affiliate_Merchants_Views_ExpensesErrorsManager&action=create&type=all","Expense","scrollbars=1, top=100, left=100, width=600, height=500, status=0");
    wnd.focus(); 
}
function editExpense(ID)
{
	var wnd = window.open("index_popup.php?md=Affiliate_Merchants_Views_ExpensesErrorsManager&action=edit&eid="+ID,"Expense","scrollbars=1, top=100, left=100, width=600, height=500, status=0");
    wnd.focus(); 
}

function resubmitExpense(ID)
{
	var wnd = window.open("index_popup.php?md=Affiliate_Merchants_Views_ExpensesErrorsManager&action=resubmit&eid="+ID,"Expense","scrollbars=1, top=100, left=100, width=600, height=500, status=0");
    wnd.focus(); 
}
...
function deleteExpense(ID)
{
  ...
  if(confirm("<?=L_G_CONFIRMDELETEEXPENSE?> - "+ID))
   	document.location.href = "index.php?md=Affiliate_Merchants_Views_ExpensesErrorsManager&type=all&eid="+ID+"&action=delete";

}
</script>
<form name=FilterForm id=FilterForm action=index.php method=get>
    <table class=listing border=0 width=600 cellspacing=0>
    <? QUnit_Templates::printFilter(10, "Expense Error Filter"); ?>
    <tr>
