<? 
include('expenses_upload_filter.tpl.php');
   ...
   <table class=listingClosed border=0 cellspacing=0 cellpadding=0>
    <tr>
        <td class=actionheader align=left>
          <? if($this->a_action_permission['create']) { ?>
            <b><a class=mainlink href="javascript:addExpense();"><?=L_G_CREATEEXPENSE?></a></b>
            &nbsp;&nbsp;|&nbsp;&nbsp;
          <? } ?>
    ...
    <tr>
        ...
        <tr>
            <td class=listViewLine>
                <? $this->a_this->printAvailableViews('Affiliate_Merchants_Views_ExpensesUploadManager'); ?>
            </td>
        </tr>
        </table>
