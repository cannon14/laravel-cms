    ...
    <tr>
        <td class=actionheader align=left>
          <? if($this->a_action_permission['create']) { ?>
            <b><a class=mainlink href="javascript:addTransaction();"><?=L_G_CREATETRANSACTION?></a></b>
            &nbsp;&nbsp;|&nbsp;&nbsp;
          <? } ?>
    ...
    <tr>
        ...
        <tr>
            <td class=listViewLine>
                <? $this->a_this->printAvailableViews('Affiliate_Merchants_Views_TransactionManager'); ?>
            </td>
        </tr>
        </table>
