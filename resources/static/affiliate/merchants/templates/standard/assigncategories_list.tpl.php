...
?>
  ...
  <script>
  	function addPage(categoryID, pageID){
  		document.location.href = "index.php?md=Affiliate_Merchants_Views_SiteToPageManager&pageID="+pageID+"&categoryId="+categoryID+"&action=addPage";
  	}
...
?>
   ...
   <table class=listingClosed border=0 width=770 cellspacing=0 cellpadding=0>
	...
	<ul id="assignedList" class="sortableList">
		...
		<tr>
		<td>
		<b><a href=index.php?md=Affiliate_Merchants_Views_SiteToPageManager&action=removePage&categoryId=<?=$_REQUEST['siteId']?>&cardpageId=<?=$rs->fields['cardpageId']?>>Remove Page</a></a> | Edit Page
