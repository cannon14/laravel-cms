...
<?  if( QUnit_Messager::getErrorMessage() != '') { ?>
        <div class="errorMessage"><?=QUnit_Messager::getErrorMessage()?></div><br>
<?  } ?>

  <form action=index.php method=post> 
  <table border=0 align=center> 
  <tr> 
    <td colspan=2 align=center><?=L_G_MERCHANTLOGIN?></td> 
  </tr><tr> 
    <td align=right><?=L_G_USERNAME2?>&nbsp;</td><td><input class=logon type=text name=username size=23 value='<?=$_REQUEST['username']?>'></td> 
  </tr><tr> 
...
<? } ?>  
  <tr> 
    <td colspan=2 align=center>
      ...
      <input type=submit class=formbutton value="<?=L_G_LOGIN?>">
    </td> 
  </tr> 
  </table> 
  </form> 
