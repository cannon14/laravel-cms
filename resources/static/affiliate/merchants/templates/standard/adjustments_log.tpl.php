<? 
include('adjustments_filter.tpl.php');
...
<? } ?>
	 ...
	 <table class=listingClosed class=listingClosed border=0 cellspacing=4 cellpadding=4 width="100%">
   <? QUnit_Templates::printFilter(20, "Adjustments Log Reports"); ?> 
	 <tr>
	 <td class=actionheader colspan="2"><a class=mainlink href="index.php?md=Affiliate_Merchants_Views_AdjustmentsLog&report=affiliate">Adjustments by Affiliate</a> | <a class=mainlink href="index.php?md=Affiliate_Merchants_Views_AdjustmentsLog&report=user">Adjustments by User</a> | <a class=mainlink href="index.php?md=Affiliate_Merchants_Views_AdjustmentsLog&report=none">None</a></td>
	 </tr>
	 <? if(isset($this->totalestimate_graph)){ ?>
	 <tr>
	 <td class=actionheader colspan="2"><b><?=$_POST['daterange']?></b></td>
	 </tr>

	 <tr>
	 	<td><b>Total Adjustments / Reversals</td>
	 </tr>
	 <tr>
	 	<td><?=$this->totaladjustment_graph ?></td>
     </tr>
	
	 <tr>
	 	<td><b>Adjusted Revenue ($)</td>
	 </tr>
	 <tr>
	 	<td><?=$this->totalestimate_graph ?></td>
     </tr>
	 
	 <tr>
	 	<td><b>Adjusted Commission ($)</td>
	 </tr>
	 <tr>
	 	<td><?=$this->totalcommission_graph ?></td>
	</tr>
 <? } ?>
	 </table>
	 <br>
   ...
   <? QUnit_Templates::printFilter(10, "Adjustments Log"); ?> 
    <tr>
    ...
    <tr>
        ...
        <tr>
            <td class=listViewLine>
                <? $this->a_this->printAvailableViews('Affiliate_Merchants_Views_AdjustmentsLog'); ?>
            </td>
        </tr>
        </table>
