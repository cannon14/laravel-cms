<div id="overDiv" style="position:absolute; visibility:hidden; z-index:1000;"></div>
  ...
  <tr>
  <td align=center>
    <table class=listing border=0  width=770cellspacing=0 cellpadding=1>
    ...
    <tr>
      <td align="left">&nbsp;<?=L_G_APPLYLOGO?>&nbsp;</td>
      <td align="left">
        <table>
            <tr>
                <td align="left">
					<input type='text' name='applyLogo' size='20' value='<?= $_POST['applyLogo']?>'>                          
                </td>
            </tr>
        </table>
      </td>
    ...
    <tr>
      <td align="left">&nbsp;<?=L_G_FTPSITE?>&nbsp;</td>
      <td align="left">
        <table>
            <tr>
                <td align="left">
					<input type='text' name='ftpSite' size='20' value='<?= $_POST['ftpSite']?>'>                          
                </td>
            </tr>
        </table>
      </td>
