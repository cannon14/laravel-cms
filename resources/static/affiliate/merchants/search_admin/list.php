...
$copyright = "<a href=\"http://www.creditcards.com/\">".phpdigMsg('powered_by')."</a>";
...
if (is_file($template)) {
    ...
    $list_title = array('title_message' => 'CreditCards.com Search '.PHPDIG_VERSION);
...
<head>
<title>CreditCards.com Search <?php print PHPDIG_VERSION ?></title>
<?php print $listmeta."\n"; ?>
...
<body bgcolor="white">
<div align="center">
<img src="phpdig_logo_2.png" width="200" height="114" alt="CreditCards.com <?php print PHPDIG_VERSION ?>" border="0" />
<br />
<?php
