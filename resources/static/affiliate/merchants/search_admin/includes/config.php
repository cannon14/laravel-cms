...
//if (isset($_REQUEST['cctem'])) { $cctem = $_REQUEST['cctem']; }
//$templates_array = array('cc.html');
//if(isset($cctem) && in_array($cctem, $templates_array)) {
//    $template = "$relative_script_path/templates/$cctem";
//} else {
    $template = "$relative_script_path/templates/cc.php";
//}
...
// now set $cctem to clean $template filename or empty string
//if (($template != "cc") && ($template != "cc")) {
//    $cctem = substr($template,strrpos($template,"/")+1); // get filename.ext from $template variable
//} else {
//    $cctem = "";
//}
...
define('LINK_TARGET','_parent');                  //Target for result links
...
define('SEARCH_PAGE','results.php');              //The name of the search page
...
define('SUMMARY_DISPLAY_LENGTH',125);            //Max chars displayed in summary
define('SNIPPET_DISPLAY_LENGTH',0);            //Max chars displayed in each snippet

define('DISPLAY_SNIPPETS',true);                 //Display text snippets
define('DISPLAY_SNIPPETS_NUM',0);                //Max snippets to display
...
define('LINKS_MAX_LIMIT',100);           //max links per each level
...
$theurl = "http://www.creditcards.com/";                   // site offering the RSS feed
$thetitle = "CreditCards.com";                             // title for site offering the RSS feed
$thedesc = "CreditCards.com :: Search Engine";  // description of site offering the RSS feed
...
define('TITLE_WEIGHT',1);                //relative title weight: APPEND_TITLE_META needs to be true
...
//--------LIST SETTINGS
define('LIST_ENABLE',false);             //do listing of past queries
