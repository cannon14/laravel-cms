...
<head>
<title>CreditCards.com : <?php phpdigPrnMsg('admin') ?></title>
...
<h3><?php phpdigPrnMsg('index_uri') ?>
</h3><form class="grey" action="spider.php" method="post">
...
http://
  ...
  <input type="radio" name="usetable" value="yes" checked> <?php phpdigPrnMsg('yes'); ?> 
  <input type="radio" name="usetable" value="no"> <?php phpdigPrnMsg('no'); ?> 
  <br/><br/>
...
<a href="cleanup_cats.php"><?php print phpdigMsg('clean')." ".phpdigMsg('t_cats'); ?></a><br/>
<a href="limit_update.php"><?php print phpdigMsg('upd_sites'); ?></a><br/>
<a href="statistics.php"><?php print phpdigMsg('statistics') ?></a><br/>
<a href="stop_.php?stop=1"><?php print phpdigMsg('StopSpider') ?></a><br/>

<a href="stuff.php">"Stuff" Words</a><br/>
<a href="preserveStuff.php">Preserve "Stuffed" Pages after crawl.</a><br/>
