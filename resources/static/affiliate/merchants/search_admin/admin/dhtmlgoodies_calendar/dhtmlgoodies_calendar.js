...
function highlightSelect()
{
	if(this.className=='selectBox'){
		...
		this.getElementsByTagName('IMG')[0].src = './calimages/down_over.gif';
	}else{
		this.className = 'selectBox';	
		this.getElementsByTagName('IMG')[0].src = './calimages/down.gif';			
	}
...
function highlightArrow()
{
	if(this.src.indexOf('over')>=0){
		if(this.src.indexOf('left')>=0)this.src = './calimages/left.gif';	
		if(this.src.indexOf('right')>=0)this.src = './calimages/right.gif';				
	}else{
		if(this.src.indexOf('left')>=0)this.src = './calimages/left_over.gif';	
		if(this.src.indexOf('right')>=0)this.src = './calimages/right_over.gif';	
	}
}
...
{
	if(this.src.indexOf('over')>=0){
		this.src = './calimages/close.gif';
	}else{
		this.src = './calimages/close_over.gif';	
	}	
