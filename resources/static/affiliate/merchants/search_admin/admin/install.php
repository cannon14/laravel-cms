...
<head>
<title>CreditCards.com : <?php phpdigPrnMsg('installation'); ?></title>
<?php include $relative_script_path.'/libs/htmlmetas.php' ?>
</head>
<body bgcolor="white">
<img src="/images/Credit-Cards-Logo-72dpi.gif" width="182" height="74" alt="CreditCards.com Search" border="0" />
