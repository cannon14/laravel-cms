<?php
$MailToAddress = "publicrelations@creditcards.com"; // your email address
$redirectURL = "public-relations-thankyou.php"; // the URL of the thank you page.
...
$MailSubject = "[Public Relations: CreditCards.com] " . $_REQUEST['EMAIL'] . $organization;
