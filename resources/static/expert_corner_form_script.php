...
$MailToAddress = "editors@creditcards.com"; // your email address
$redirectURL = "expert-corner-thankyou.php"; // the URL of the thank you page.

# optional settings
$MailSubject = "[Expert Q&A: CreditCards.com]"; // the subject of the message you will receive
